...
import { renderVehicleInspectionOverview, renderHlf1Inspection, renderHlf2Inspection, renderMtfInspection } from './pages/vehicle-inspection-types.js';
import { renderInspectionTemplateEditor } from './pages/inspection-template-editor.js';
...
registerRoute('#/vehicle-inspection', renderVehicleInspectionOverview);
registerRoute('#/hlf1-inspection', renderHlf1Inspection);
registerRoute('#/hlf2-inspection', renderHlf2Inspection);
registerRoute('#/mtf-inspection', renderMtfInspection);
registerRoute('#/inspection-templates', renderInspectionTemplateEditor);
...
registerRoute('#/zeiterfassung', renderPersonal,  'personal');
